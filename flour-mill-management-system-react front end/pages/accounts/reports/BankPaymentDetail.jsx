...
const BankPaymentDetail = () => {
  return (
    <PageShell title="Bank Payment Detail Report">
<div className="mt-4 p-4 border rounded-md bg-slate-50">
                ...
                <p className="text-slate-400 text-center text-sm mt-2">This report will list all payments made from bank accounts within a specified period.</p>
            </div>
        </PageShell>);
