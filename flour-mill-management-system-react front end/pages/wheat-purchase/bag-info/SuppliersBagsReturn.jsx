...
const SuppliersBagsReturn = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await apiFetch(`${API}/wheat/bags/returns`, {
        method: 'POST',
      ...
      const data = await res.json();
      if (res.ok) {
        alert('✅ Bags return recorded successfully!');
        setQuantity('');
        setRemarks('');
      } else {
  ...
  return (
    <PageShell title="Supplier's Bags Return">
            <div className="max-w-4xl mx-auto bg-slate-50 p-8 rounded-lg border border-slate-200">
                ...
                type="text"
                id="voucherNo"
                value="SBR-2024-0031" // Example auto-generated number
...
export default SuppliersBagsReturn;