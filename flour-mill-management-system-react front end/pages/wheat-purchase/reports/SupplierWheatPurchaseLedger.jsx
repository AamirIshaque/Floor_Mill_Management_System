...
const SupplierWheatPurchaseLedger = () => {
  ...
  const load = async () => {
    ...
    try {
      setLoading(true);
      const res = await apiFetch(`${API}/wheat/reports/supplier-purchase-ledger?${q.toString()}`);
      const data = await res.json();
  ...
  return (
    <PageShell title="Supplier Wheat Purchase Ledger">
...
export default SupplierWheatPurchaseLedger;
