...
const DailyWheatPurchase = () => {
  ...
  const load = async () => {
    ...
    try {
      setLoading(true);
      const res = await apiFetch(`${API}/wheat/reports/daily?${q.toString()}`);
  ...
  return (
    <PageShell title="Daily Wheat Purchase Report">
...
export default DailyWheatPurchase;
